...
.service-title {
  ...
  max-height: 3.6em; /* adjust based on font-size and line-height */
  position: relative;
  cursor: pointer;
}
...
<!-- /Hero Section -->
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <!-- <div class="col-lg-6 position-relative order-last content" data-aos="fade-up" data-aos-delay="200">
            ...
            <ul><h5>School Theme Song</h5></ul>
            <div class="video-wrapper position-relative">
            <img src="assets/img/about.jpg" class="img-fluid" alt="school video">
          ...
          <div class="col-lg-12 content" data-aos="fade-up" data-aos-delay="100">
            ...
            <li>
                ...
                <div>
                  <h5>Our Legacy</h5>
                  <p>Founded with the vision of providing quality education to gifted young women, Devi Balika Vidyalaya has consistently upheld values of discipline, integrity, and intellectual curiosity. Our alumni have made significant contributions across various fields, reflecting the school's dedication to producing well-rounded individuals.</p>
                </div>
              </li>
              ...
              <li>
                ...
                <div>
                  ...
                  <p>Our rigorous academic programs are designed to challenge and inspire students, fostering critical thinking and a lifelong love for learning. With a team of dedicated educators, we ensure that each student receives personalized guidance to achieve her fullest potential.</p>
                </div>
              </li>
              ...
              <li>
                ...
                <div>
                  ...
                  <p>At Devi Balika Vidyalaya, education transcends traditional boundaries. Our diverse range of extracurricular activities including clubs, societies, and sports encourages students to explore their passions, develop leadership skills, and engage with the community.
                     <br> As we continue to build upon our rich heritage, Devi Balika Vidyalaya remains committed to shaping the future of Sri Lanka through the empowerment of young women. 
                  </p>
                </div>
              </li>
            </ul>
    ...
    <section id="featured-services" class="featured-services section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <?php 
          ...
          $query = "SELECT * FROM tbl_news WHERE expire_date >= CURDATE() ORDER BY expire_date DESC";
 ...
 <!-- include footer -->
  ...
  <!-- Add this in the <head> or right before </body> -->
